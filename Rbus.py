...
# kerala bus
lists_k=[]
df_k=pd.read_csv("C:/Users/HP/Desktop/MY PROJECTS/RED BUS/csv files/dfk.csv")
for i,r in df_k.iterrows():
    lists_k.append(r["route_name"])

#Andhra bus
lists_A=[]
df_A=pd.read_csv("C:/Users/HP/Desktop/MY PROJECTS/RED BUS/csv files/dfA.csv")
for i,r in df_A.iterrows():
    lists_A.append(r["route_name"])

#Telungana bus
lists_T=[]
df_T=pd.read_csv("C:/Users/HP/Desktop/MY PROJECTS/RED BUS/csv files/dfT.csv")
for i,r in df_T.iterrows():
    lists_T.append(r["route_name"])

#Kadamba bus
lists_ka=[]
df_G=pd.read_csv("C:/Users/HP/Desktop/MY PROJECTS/RED BUS/csv files/dfK.csv")
for i,r in df_G.iterrows():
    lists_ka.append(r["route_name"])

#Rajastan bus
lists_R=[]
df_R=pd.read_csv("C:/Users/HP/Desktop/MY PROJECTS/RED BUS/csv files/dfR.csv")
...
# South bengal bus 
lists_SB=[]
df_SB=pd.read_csv("C:/Users/HP/Desktop/MY PROJECTS/RED BUS/csv files/dfSB.csv")
for i,r in df_SB.iterrows():
    lists_SB.append(r["route_name"])

# Haryana bus
lists_H=[]
df_H=pd.read_csv("C:/Users/HP/Desktop/MY PROJECTS/RED BUS/csv files/dfH.csv")
for i,r in df_H.iterrows():
    lists_H.append(r["route_name"])

#Assam bus
lists_AS=[]
df_AS=pd.read_csv("C:/Users/HP/Desktop/MY PROJECTS/RED BUS/csv files/dfAS.csv")
for i,r in df_AS.iterrows():
    lists_AS.append(r["route_name"])

#UP bus
lists_UP=[]
df_UP=pd.read_csv("C:/Users/HP/Desktop/MY PROJECTS/RED BUS/csv files/dfUP.csv")
for i,r in df_UP.iterrows():
    lists_UP.append(r["route_name"])

#West bengal bus
lists_WB=[]
df_WB=pd.read_csv("C:/Users/HP/Desktop/MY PROJECTS/RED BUS/csv files/dfWB.csv")
...
if web=="Home":
    ...
    slt.subheader(":blue[Developed-by:]  Mangesh Khobragade")

# States and Routes page setting
if web == "📍States and Routes":
    S = slt.selectbox("Lists of States", ["Kerala", "Adhra Pradesh", "Telugana", "Kadamba", "Rajastan", 
    ...
    if S == "Kerala":
        ...
        def type_and_fare(bus_type, fare_range):
            conn = mysql.connector.connect(host="localhost", user="root", password='Mangesh@6305', database="redbusdetail")
            ...
            df = pd.DataFrame(out, columns=[
                ...
                "Prices", "Seats_Available", "Ratings", "Route_link", "Route_names"
            ])
            return df
    ...
    if S=="Adhra Pradesh":
        ...
        def type_and_fare_A(bus_type, fare_range):
            ...
            df = pd.DataFrame(out, columns=[
                "ID", "Bus_name", "Bus_type", "Start_time", "End_time", "Total_duration",
                "Price", "Seats_Available", "Ratings", "Route_link", "Route_names"
            ])
            return df
    ...
    if S=="Kadamba":
        G=slt.selectbox("list of routes",lists_ka)
